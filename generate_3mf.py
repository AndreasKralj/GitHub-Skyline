...
def generate_3mf(base_stl_path, bars_stl_path, output_path, display_name,
    ...
    model_settings = (
        ...
        '    <metadata key="brim_object_gap" value="0.3"/>\n'
        '    <metadata key="brim_type" value="outer_and_inner"/>\n'
        ...
        '      <metadata key="skeleton_infill_density" value="20%"/>\n'
        '      <metadata key="skin_infill_density" value="20%"/>\n'
        ...
        '      <metadata key="skeleton_infill_density" value="80%"/>\n'
        '      <metadata key="skin_infill_density" value="80%"/>\n'
